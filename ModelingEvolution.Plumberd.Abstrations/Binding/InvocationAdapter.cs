...
namespace ModelingEvolution.Plumberd.Binding
{
    ...
    {
        private static HandlerDispatcher Build(VoidHandlerParameterAdapter<TArg0, TArg1, TArg2> paramAdapter,
        ...
        public HandlerDispatcher Build(HandlerParameterAdapter parameterAdapter, HandlerResultAdapter resultAdapter)
        {
            ...
            var handlerParameterAdapter = (VoidHandlerParameterAdapter<TArg0, TArg1, TArg2>)parameterAdapter;
            return Build(handlerParameterAdapter,
                handlerResultAdapter);
        }
    }
    public class InvocationAdapter<TArg0, TArg1, TArg2, TArg3, TResult> : IInvocationAdapter
    {
        private static HandlerDispatcher Build(HandlerParameterAdapter<TArg0, TArg1, TArg2, TArg3,TResult> paramAdapter,
        ...
        public HandlerDispatcher Build(HandlerParameterAdapter parameterAdapter, HandlerResultAdapter resultAdapter)
        {
            ...
            var handlerParameterAdapter = (HandlerParameterAdapter<TArg0, TArg1, TArg2,TArg3, TResult>)parameterAdapter;
            return Build(handlerParameterAdapter, handlerResultAdapter);
        }
    }
